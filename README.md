...
## Generating the Container with Docker Compose

To set up WordPress using Docker Compose, follow these steps:
...
4. Once the containers are running, open your browser and navigate to `http://localhost` (or the appropriate URL based on your Docker setup).
